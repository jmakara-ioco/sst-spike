...
#nullable disable
    ;
    #nullable restore
    public partial class VezaVITileControl : global::Microsoft.AspNetCore.Components.ComponentBase
    #nullable disable
    {
...
#nullable restore
#line 12 "D:\Code\CloudberrySoftwareSolutions\SST-Law\ContractBuilder-main\SST\Shared Libraries\VezaVI.Components\VezaVITileControl.razor"
    ...
    public string CssClass {
        get
        {
            return $"grid-col-{Columns} {AdditionalCssClass}";
        }
    }
    ...
    private List<VezaVITile> Tiles = new List<VezaVITile>();

    public void AddTile(VezaVITile tile)
    {
        Tiles.Add(tile);
        StateHasChanged();
    }

    public void RemoveTile(VezaVITile tile)
    {
        Tiles.Remove(tile);
        StateHasChanged();
    }
