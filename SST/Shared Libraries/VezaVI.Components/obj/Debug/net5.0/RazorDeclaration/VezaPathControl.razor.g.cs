...
#nullable disable
    ;
    #nullable restore
    public partial class VezaPathControl : global::Microsoft.AspNetCore.Components.ComponentBase
    #nullable disable
    {
...
#nullable restore
#line 11 "D:\Code\CloudberrySoftwareSolutions\SST-Law\ContractBuilder-main\SST\Shared Libraries\VezaVI.Components\VezaPathControl.razor"
    ...
    [Parameter]
    public TreeType DisplayType { get; set; }
    [Parameter]
    public List<VezaPathNode> PathNodes { get; set; }

    public string TreeCSS()
    {
        switch (DisplayType)
        {
            case TreeType.DecisionTree:
                return "vi-flow-decision-tree";
            case TreeType.Dendogram:
                return "vi-flow-dendrogram";
            default:
            case TreeType.FamilyTree:
                return "vi-flow-family-tree";
        }
    }
