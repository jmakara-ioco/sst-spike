...
namespace VezaVI.Light.Components
{
    ...
    public class EmailElementTextImageColumn : IDragableElement, INotifyPropertyChanged
    {
        public Guid? ElementID { get; set; }
        public string Caption => "Email Element (Text | Image)";
        ...
        {
            return new EmailElementTextImageColumn()
            {
                State = state
            };
        }

        public Type RenderType => typeof(EmailElementTextImageColumnRenderer);
    }

    public class EmailElementTextImageColumnRenderer : ComponentBase, IDragableComponent
    {
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            else
            {
                ...
                builder.AddAttribute(++seq, "style", "width: 50%; height: 100%; float: left;");
                ...
                builder.AddAttribute(++seq, "style", "width: 50%; float: right;");
