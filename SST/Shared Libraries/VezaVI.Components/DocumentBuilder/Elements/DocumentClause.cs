...
{
    [AllowedConfig(ConfigType.Clause)]
    public class DocumentClause : IDragableElement, INotifyPropertyChanged
    {
        public Guid? ElementID { get; set; }
        public string Caption => "Document Clause";
        ...
        public Type RenderType => typeof(DocumentClauseRenderer);
    ...
    public class DocumentClauseRenderer : ComponentBase, IDragableComponent
    {
        [Parameter]
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            if (Element.State == DocumentBuilderElementListType.Toolbar)
            {
                ...
                builder.AddAttribute(seq++, "class", "oi oi-document");
            ...
            {
                builder.OpenElement(seq++, "span");
                builder.AddAttribute(seq++, "class", "oi oi-document vi-editor-icon");
                builder.CloseElement();
