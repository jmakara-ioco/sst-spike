...
namespace VezaVI.Light.Components
{
    ...
    public class DocumentList : IDragableElement, INotifyPropertyChanged
    {
        ...
        public Type RenderType => typeof(DocumentListRenderer);
    ...
    public class DocumentListRenderer : ComponentBase, IDragableComponent
    {
        [Parameter]
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            if (Element.State == DocumentBuilderElementListType.Toolbar)
            {
                ...
                builder.AddAttribute(seq++, "class", "oi oi-list");
            ...
            {
                builder.OpenElement(seq++, "span");
                builder.AddAttribute(seq++, "class", "oi oi-list vi-editor-icon");
                builder.CloseElement();
